...
public class CoreFragment extends Fragment {
    ...
    private String type = "accelerate";
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        //showLineChart = new ShowLineChart((LineChartView)view.findViewById(R.id.core_chart), "accelerate");
        lineChart = new MyLineChart((LineChartView)view.findViewById(R.id.core_chart), 1, 10, 1000, Color.BLUE);
        textView = view.findViewById(R.id.core_text);
        //get();
        getData();
        return view;
    }
...
//            int tmp = 0;
            for(int i = 0; i < jsonArray.length(); i++){
                ...
                String avg = dataObject.getString("acc");
